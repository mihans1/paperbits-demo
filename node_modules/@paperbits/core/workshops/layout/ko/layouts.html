...
<div class="flex flex-column fit">
    ...
    <div class="flex flex-column flex-item flex-item-grow" role="list" data-bind="foreach: layouts, scrollable: true">
        <a href="#" role="listitem" class="list-item"
            data-bind="css: { selected: hasFocus }, hasFocus: hasFocus, activate: $component.selectLayout">
