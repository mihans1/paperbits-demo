<div class="style-guide container" data-bind="if: styles">
    ...
    <article>
        ...
        <div class="row">
            <div class="col col-md-12 samples">
                <!-- ko foreach: { data: $component.fonts, as: 'font' } -->
                ...
                <div class="style-card style-card-empty">
                    <button class="btn-round" data-bind="click: $component.addFonts"></button>
    ...
    <article>
        ...
        <div class="row">
            <div class="col col-md-12 samples">
                <!--ko foreach: { data: $component.textStyles, as: 'textStyle' }-->
                ...
                <!--/ko-->
                <div class="style-card style-card-empty">
                    <button class="btn-round" data-bind="click: $component.addTextStyleVariation"></button>
                    <div class="style-card-label">
                        Add variation
                    </div>
                </div>
    ...
    <article>
        ...
        <div class="samples">
            <!-- ko foreach: { data: $component.colors, as: 'color' } -->
            <div class="sample style-card" data-bind="styleable: color">
                <div tabindex="0" class="style-card-square"
                    data-bind="attr: { title: color.displayName }, style: { background: color.value }"></div>
                <span class="style-card-label" data-bind="text: color.displayName"></span>
            </div>
            <!--/ko -->
            <div class="style-card style-card-empty">
                <button class="btn-round" data-bind="click: $component.addColor"></button>
                <div class="style-card-label">
                    Add color
                </div>
            </div>
    ...
    <article>
        ...
        <div class="samples">
            <!-- ko foreach: { data: $component.gradients, as: 'gradient' } -->
            ...
            <!--/ko -->
            <div class="style-card style-card-empty">
                <button class="btn-round" data-bind="click: $component.addGradient"></button>
                <div class="style-card-label">
                    Add gradient
                </div>
            </div>
    ...
    <article>
        ...
        <div class="samples">
            <!-- ko foreach: { data: $component.shadows, as: 'shadow' } -->
            ...
            <!--/ko -->
            <div class="style-card style-card-empty">
                <button class="btn-round" data-bind="click: $component.addShadow"></button>
                <div class="style-card-label">
                    Add shadow
                </div>
            </div>
    ...
    <article>
                ...
                <div class="style-card" data-bind="styleable: components.formControl.default">
                    <div class="style-card-body">
                        <div class="form-group">
                            <label>Label</label>
                            <input type="text" class="form-control no-pointer-events" value="Input value"
                                data-bind="stylePreview:components.formControl.default" />
                        </div>
                    </div>
        ...
        <!-- <input type="text" value="Input value" data-bind="stylePreview:components.formControl.default" />

        <textarea data-bind="stylePreview:components.formControl.default">Text area content</textarea> -->
    </article>

    <!--ko foreach: { data: $component.uiComponents, as: 'item' }-->
    <article>
        <h2 class="heading" data-bind="text: item.displayName">Component</h2>
        <div class="row">
            <div class="col col-md-12 samples">
                <!--ko foreach: { data: item.variations, as: 'variation' }-->
                ...
                <!--/ko-->
                <div class="style-card style-card-empty">
                    <!-- <a href="#" class="btn-round" data-bind="balloon: { component: { name: 'style-snippet-selector', params: { snippetType: 'components/' + item.name, onSelect: $component.onSnippetSelected } } }">
                        <i class="paperbits-icon paperbits-color"></i>
                    </a> -->
                    <button class="btn-round" data-bind="click: $component.openInEditor.bind($data, item.name)"></button>
                    <div class="style-card-label">
                        Add variation
                    </div>
                </div>
